    ...
    <div>
      <div className="container mx-auto flex flex-col md:flex-row py-10 px-4 md:px-0">
        ...
        <div className="basis-1/2">
          <h3 className="text-2xl">{productDetail.title}</h3>
          <div className="flex items-center gap-2 my-3">
            <Badge size="lg">Price: ${productDetail.price}</Badge>
            <Badge size="lg">
              Category:{' '}
              {productDetail.category.charAt(0).toUpperCase() +
                productDetail.category.slice(1).toLowerCase()}
            </Badge>
          </div>
          <Button color="purple" size="xs" className="mt-3">
      ...
      <div className="bg-[#F2F4F8] px-4 md:px-0">
        <div className="container mx-auto py-5">
          <div className="bg-white p-5 w-full lg:w-1/2 rounded-lg shadow">
            ...
            <h4 className="font-bold text-xl mb-2">{productDetail.title}</h4>
